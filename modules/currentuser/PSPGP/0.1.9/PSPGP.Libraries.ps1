if ($PSEdition -eq 'Core') {
    Add-Type -Path $PSScriptRoot\Lib\Standard\BouncyCastle.Crypto.dll
    Add-Type -Path $PSScriptRoot\Lib\Standard\PgpCore.dll
} else {
    Add-Type -Path $PSScriptRoot\Lib\Standard\BouncyCastle.Crypto.dll
    Add-Type -Path $PSScriptRoot\Lib\Standard\PgpCore.dll
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCipQdt5nlYQUccfi9VdP0BS/
# yNqgghhnMIIDtzCCAp+gAwIBAgIQDOfg5RfYRv6P5WD8G/AwOTANBgkqhkiG9w0B
...
# CzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOVKKO1shpySIxhwuCaD
# wrr1wkmKMA0GCSqGSIb3DQEBAQUABIIBAJeUQXeFffY8MqJ3FKZWfM9Z7MOve1pg
# 838jAxjMGTX1rb0B3sPWeSWODvJeGyvJoJ2imgVlZ4bOrnFahcOBLGiTSQfao1u5
# FVCwURGJvtrueXEXI8pBt4e9iKTf9XTXqEy1d3uES7OzDi96PdpqNy6Z+ncTlt0n
# /J8wT8uqI4Tbb6k12P2dr+E0O1gt3UJsZy2elJPytbZaDERzeCa07cQ+6nesOWWx
# M/FEvxvFH+EFs7RRjun2YRdi/5dzZl3SqKSdCcbkvFMH2NoZR8JaP2/094z4Jk1f
# oBF7gJmwFZNk3fdOhy+puHXWcl+IclY60mAlMCtUZN3OXiWUYhuSf9ehggIwMIIC
...
# hvcNAQkEMSIEIG6++JScgXF0tL3BE5AnD9W7bNOCuyNbz3VG+Wyly4zQMA0GCSqG
# SIb3DQEBAQUABIIBAEaLb8caeg4ugBrNbo5dxmQwTdJTMTFBGne6Hgw7vR7JI5KU
# sh4UrYZmlBobiRVcp9j92c3Q8oss8DMEMuC4YNAPCDzhBAZybtLqsOlw2rlcnwfJ
# 5D2Wgpdtyl1DvAfSqC3r0vANB38GjE3x6xDE2sR7y+Jkp/40Cdp5pOui4ges+exb
# FuMbRQ2xGB4QoFU8Zyq5jdAHB58emwm+mu+I4DEXKLTyKAm6DHoT3G/x5SyyAnnu
# gGsoHIjs5GuQNAL8FAbl4jYrM0fap6QyxUAKysPie0ZO+Q03NKZkpv0rFQJI7FB5
# fgzA87+qvtNYLO7T21IYZlEu/dy22UelG+QNq58=
